...
/**
 * The purpose of this class is to provide a little framework for easing the
 * test of semantic browser-related queries.
 * 
 * Each query under test shall:
 * <ul>
 * <li>first generate a list of identifiers for the test model the query will
 * used on</li>
 * <li>extend this previously generated class</li>
 * <li>add unimplemented method from this class to provide the category
 * identifier of the query (see in the contribution of the extension point) and
 * the semantic browser view the query is related to (see also in the
 * contribution of the extension point)</li>
 * </ul>
 * 
...
public abstract class AbstractSemanticQueryTestCase extends BasicTestCase {
	...
	/**
	 * Query the category registry to find the category related to the query
	 * under test.
	 * 
	 * @param categoryId

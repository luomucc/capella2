...
public class MultiPartTCWithImplementationAmbiguity extends AbstractInterfaceDecompositionRefinementTest {

  @SuppressWarnings("unchecked")
  public MultiPartTCWithImplementationAmbiguity() {
    super(Messages.MultiPartTCWithImplementationAmbiguity_Name,
        Messages.MultiPartTCWithImplementationAmbiguity_Desc,
        Collections.singletonList(Messages.MultiPartTC_LogicalArchitecture),
        Collections.singletonList(Messages.MultiPartTC_LogicalArchitecture),
        Messages.MultiPartTCWithImplementationAmbiguity_Src,
        Messages.MultiPartTCWithImplementationAmbiguity_Ref,

...
/**
 * test on TC_DF_13: This rule verifies that all exchange items allocated by a function port are allocated by one of its realizing function ports.
 * @generated
 */
public class Rule_TC_DF_13 extends AbstractRulesOnTransitionTest {
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"1dcb5818-0508-44c3-a36b-4d971ac7fafb",
				"f9271719-174f-423c-b5fd-1ffec12c7358",
				"fe754c43-4779-4a4a-a828-2a84029577fc",
				"41c01a37-869d-4734-8e30-97975692b881" });
	}
		...
		return Arrays
				.asList(new OracleDefinition[] {
						new OracleDefinition(
								"fe754c43-4779-4a4a-a828-2a84029577fc", 1),
						new OracleDefinition(

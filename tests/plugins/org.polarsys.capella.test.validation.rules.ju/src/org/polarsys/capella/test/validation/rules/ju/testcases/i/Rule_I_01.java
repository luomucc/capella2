 ...
 * @generated
 */
public class Rule_I_01 extends AbstractRulesOnIntegrityTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.information.validation.I_01";
	}
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"876030fd-3430-4b14-9974-3ae7c818fc7c",
				"193ec2f0-8802-4314-9045-268484e19e72" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"193ec2f0-8802-4314-9045-268484e19e72", 1) });
	}
}

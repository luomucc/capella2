...
/**
 * test on I_33:  This rule checks that reused parts are not used when the project approach is in default mode (not in reusable mode).
 * @generated
 */
public class Rule_I_33 extends AbstractRulesOnIntegrityTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.core.validation.I_33";
	}
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"fd832907-782d-4169-82b7-ef16c3617a3a",
				"101c95a7-a103-4644-9d6a-9254d7478808" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"101c95a7-a103-4644-9d6a-9254d7478808", 1) });
	}
}

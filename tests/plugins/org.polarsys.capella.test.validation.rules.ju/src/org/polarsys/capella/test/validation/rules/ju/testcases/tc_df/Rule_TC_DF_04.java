...
public class Rule_TC_DF_04 extends AbstractRulesOnTransitionTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.fa.validation.TC_DF_04";
	}
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"98cd11b7-7de5-4b4b-a2e3-c97eddf0bb66",
				"af129081-8c1a-410d-8816-3f045abc2261" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"af129081-8c1a-410d-8816-3f045abc2261", 1) });
	}
}

...
/**
 * test on DWF_I_07: This rule checks that a component uses/implements interfaces from the same level or from an upper level.
 * @generated
 */
public class Rule_DWF_I_07 extends AbstractRulesOnDesignTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.cs.validation.DWF_I_07";
	}

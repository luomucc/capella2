...
/**
 * test on DWF_DF_05: This check ensures that all the functions involved in FunctionalChain are also active in modes and states as FunctionChain
 * @generated
 */
public class Rule_DWF_DF_05 extends AbstractRulesOnDesignTest {
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"d84f31d0-482b-4d69-9769-a0e30ccd7e55",
				"94543312-5e65-483f-b829-84bd19dbb263" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"94543312-5e65-483f-b829-84bd19dbb263", 1) });
	}
}

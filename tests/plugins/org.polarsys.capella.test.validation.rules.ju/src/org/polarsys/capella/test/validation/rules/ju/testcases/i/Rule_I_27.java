 ...
 * @generated
 */
public class Rule_I_27 extends AbstractRulesOnIntegrityTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.fa.validation.I_27";
	}
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"beac6225-7fc7-4b66-b4b8-d0fcf72b37bf",
				"209ccca6-fe03-4fdf-978f-bbd7add5a421" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"209ccca6-fe03-4fdf-978f-bbd7add5a421", 1) });
	}
}

 ...
 * @generated
 */
public class Rule_TC_DC_08 extends AbstractRulesOnTransitionTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.fa.validation.TC_DC_08";
	}
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"eab5ad93-09a3-473c-aad7-ae0a171af5be",
				"cd89d73d-5310-4294-9a35-dc56cc5fdc7a" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"cd89d73d-5310-4294-9a35-dc56cc5fdc7a", 1) });
	}
}

...
public class Rule_TC_I_03 extends AbstractRulesOnTransitionTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.cs.validation.TC_I_03";
	}
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"a961eb1d-678b-41b5-a779-b633f8dc91d1",
				"29996d85-b415-4604-816a-3fd4be75725e" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"29996d85-b415-4604-816a-3fd4be75725e", 1) });
	}
}

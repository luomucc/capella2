...
/**
 * test on TJ_LA_07: This rule ensures that a Logical Actor realizes at least one System Actor.
 * @generated
 */
public class Rule_TJ_LA_07 extends AbstractRulesOnTransitionTest {
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"1f4c29ae-4d9f-4e2e-a036-94bce7e4c238",
				"02406f91-1fb8-4b07-bae6-4d910aef308a" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"02406f91-1fb8-4b07-bae6-4d910aef308a", 1) });
	}
}

...
/**
 * test on TC_I_02: This rule checks that an ExchangeItemElement isn't linked to a Type from a previous level whereas it is realized in the same level than the ExchangeItemElement. ExchangeItemElement should be linked to the realized Type. A warning can be raised if you have performed a transition of the ExchangeItemElement before performing a transition of the linked Type. You should perform another transition of the ExchangeItemElement from the lower level to use the realized Type
 * @generated
 */
public class Rule_TC_I_02 extends AbstractRulesOnTransitionTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.information.validation.TC_I_02";
	}
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"52746988-411e-47da-be5f-9d07a1386293",
				"201b8d81-4e7d-4ca4-909d-3cfb79393531" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"201b8d81-4e7d-4ca4-909d-3cfb79393531", 1) });
	}
}

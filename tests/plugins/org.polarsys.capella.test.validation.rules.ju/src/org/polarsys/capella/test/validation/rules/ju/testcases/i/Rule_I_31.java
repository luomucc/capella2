...
/**
 * test on I_31:  This rule checks that a Component Exchange/Physical Link End doesn't have a part Null
 * @generated
 */
public class Rule_I_31 extends AbstractRulesOnIntegrityTest {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.core.validation.I_31";
	}
	...
	protected List<String> getScopeDefinition() {
		return Arrays.asList(new String[] {
				"84c27eef-d78d-4c5e-b14b-64d7b07b39c5",
				"9290779a-04dc-44d7-a020-4640bcd64a82" });
	}
	...
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition[] { new OracleDefinition(
				"9290779a-04dc-44d7-a020-4640bcd64a82", 1) });
	}
}

 ...
 */
public class Rule_DC_CL_01 extends ValidationRuleTestCase {
	...
	protected String getRuleID() {
		return "org.polarsys.capella.core.data.information.validation.DC_CL_01"; //$NON-NLS-1$
	}

	@Override
	protected List<OracleDefinition> getOracleDefinitions() {
		return Arrays.asList(new OracleDefinition [] {
				new OracleDefinition("0172e9f2-8b60-4145-b264-be46d8eb3f17", 1), //$NON-NLS-1$

...
public class CCScenario extends EmptyProject {
  ...
  public void test() throws Exception {
    ...
    diagram.createCapabilityInvolvement(GenericModel.CAPABILITY_1, GenericModel.ACTOR_1);

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.test.diagram.layout.ju.layout.NodeLayout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeLayoutItemProvider 
   ...
   * @generated
   */
  public NodeLayoutItemProvider(AdapterFactory adapterFactory) {
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(LayoutPackage.Literals.NODE_LAYOUT__BOUNDS);
      childrenFeatures.add(LayoutPackage.Literals.NODE_LAYOUT__OWNED_LAYOUTS);
    }
  ...
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/NodeLayout"));
  }
  ...
  public String getText(Object object) {
    String label = ((NodeLayout)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_NodeLayout_type") : label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(NodeLayout.class)) {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add
      (createChildParameter
        (LayoutPackage.Literals.NODE_LAYOUT__BOUNDS,
         LayoutFactory.eINSTANCE.createBounds()));

    newChildDescriptors.add
      (createChildParameter
        (LayoutPackage.Literals.NODE_LAYOUT__OWNED_LAYOUTS,
         LayoutFactory.eINSTANCE.createDiagramLayout()));

    newChildDescriptors.add
      (createChildParameter
        (LayoutPackage.Literals.NODE_LAYOUT__OWNED_LAYOUTS,
         LayoutFactory.eINSTANCE.createEdgeLayout()));

    newChildDescriptors.add
      (createChildParameter
        (LayoutPackage.Literals.NODE_LAYOUT__OWNED_LAYOUTS,
         LayoutFactory.eINSTANCE.createNodeLayout()));

    newChildDescriptors.add
      (createChildParameter
        (LayoutPackage.Literals.NODE_LAYOUT__OWNED_LAYOUTS,
         LayoutFactory.eINSTANCE.createNoteLayout()));
  }

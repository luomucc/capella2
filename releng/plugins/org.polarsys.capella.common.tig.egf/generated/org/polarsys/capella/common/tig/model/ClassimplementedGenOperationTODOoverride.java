...
public class ClassimplementedGenOperationTODOoverride
	...
	protected final String TEXT_12 = " e) {" + NL
			+ "\t\t\t\tthrow new UnsupportedOperationException(e.getLocalizedMessage());" + NL + "\t\t\t}" + NL
			+ "\t\t}" + NL + "\t\t" + NL + "\t\t";
	...
	protected final String TEXT_26 = ">) query.evaluate(this);" + NL + "\t\treturn new ";
	protected final String TEXT_27 = ".UnmodifiableEList<";
	protected final String TEXT_28 = ">(result.size(), result.toArray());" + NL + "\t";
	protected final String TEXT_29 = NL + "\t\treturn ((";
	protected final String TEXT_30 = ") query.evaluate(this)).";
	protected final String TEXT_31 = "();" + NL + "\t";
	protected final String TEXT_32 = NL + "\t\treturn (";
	protected final String TEXT_33 = ") query.evaluate(this);" + NL + "\t";

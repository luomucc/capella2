...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.common.data.modellingcore.AbstractRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractRelationshipItemProvider
	 ...
	 * @generated
	 */
	public AbstractRelationshipItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_AbstractRelationship_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_AbstractRelationship_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

...
/**
 * This class is intended to extends Eclipse menu contributions to popupMenus displayed in modal dialogs. By providing a
 * ISelectionProvider and a locationUri, menuContributions provided within org.eclipse.ui.menus extension points will be
 * contributed to the menuManager, even if the popup is in a modal dialog.
 */
public class ModalContextMenuExtender {
   ...
   * @param provider
   * @param locator,
   *          the parent ServiceLocator (activeWorkbenchWindow for instance)
   */
  ...
  public void registerContextMenu() {
    ...
    final ContextMenuSelectionService newService = new ContextMenuSelectionService(provider);

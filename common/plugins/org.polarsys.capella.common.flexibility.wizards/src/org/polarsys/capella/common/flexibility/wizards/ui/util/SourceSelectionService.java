 ...
 */
public class SourceSelectionService extends AbstractSourceProvider implements ISelectionChangedListener, ISelectionService {
   ...
   */
  public SourceSelectionService(ISelectionProvider activeProvider) {

...
public class MigrationConstants {
  ...
  public static final String CAPELLA_COMMON_OLD_NSURI = "http://www.polarsys.org/capella/core/common/1.1.0";
  public static final String CAPELLA_CORE_OLD_NSURI = "http://www.polarsys.org/capella/core/core/1.1.0";
  public static final String COMPOSITE_STRUCTURE_OLD_NSURI = "http://www.polarsys.org/capella/core/cs/1.1.0";
  public static final String CONTEXT_ARCHITECTURE_OLD_NSURI = "http://www.polarsys.org/capella/core/ctx/1.1.0";
  public static final String EPBS_ARCHITECTURE_OLD_NSURI = "http://www.polarsys.org/capella/core/epbs/1.1.0";
  public static final String FUNCTIONAL_ANALYSIS_OLD_NSURI = "http://www.polarsys.org/capella/core/fa/1.1.0";
  public static final String INFORMATION_OLD_NSURI = "http://www.polarsys.org/capella/core/information/1.1.0";
  public static final String INFORMATION_COMMUNICATION_OLD_NSURI = "http://www.polarsys.org/capella/core/information/communication/1.1.0";
  public static final String INFORMATION_DATATYPE_OLD_NSURI = "http://www.polarsys.org/capella/core/information/datatype/1.1.0";
  public static final String INFORMATION_DATAVALUE_OLD_NSURI = "http://www.polarsys.org/capella/core/information/datavalue/1.1.0";
  public static final String INTERACTION_OLD_NSURI = "http://www.polarsys.org/capella/core/interaction/1.1.0";
  public static final String LOGICAL_ARCHITECTURE_OLD_NSURI = "http://www.polarsys.org/capella/core/la/1.1.0";
  public static final String CAPELLA_MODELLER_OLD_NSURI = "http://www.polarsys.org/capella/core/modeller/1.1.0";
  public static final String OPERATIONAL_ANALYSIS_OLD_NSURI = "http://www.polarsys.org/capella/core/oa/1.1.0";
  public static final String PHYSICAL_ARCHITECTURE_OLD_NSURI = "http://www.polarsys.org/capella/core/pa/1.1.0";
  public static final String PHYSICAL_ARCHITECTURE_DEPLOYMENT_OLD_NSURI = "http://www.polarsys.org/capella/core/pa/deployment/1.1.0";
  public static final String REQUIREMENT_OLD_NSURI = "http://www.polarsys.org/capella/core/requirement/1.1.0";
  public static final String SHARED_MODEL_OLD_NSURI = "http://www.polarsys.org/capella/core/sharedmodel/1.1.0";

  public static final String ACTIVITY_OLD_NSURI = "http://www.polarsys.org/capella/common/activity/1.1.0";
  public static final String BEHAVIOR_OLD_NSURI = "http://www.polarsys.org/capella/common/behavior/1.1.0";
  public static final String MODELLING_CORE_OLD_NSURI = "http://www.polarsys.org/capella/common/core/1.1.0";

  public static final String LIBRARIES_OLD_NSURI = "http://www.polarsys.org/capella/common/libraries/1.1.0";
  public static final String RE_OLD_NSURI = "http://www.polarsys.org/capella/common/re/1.1.0";
  ...
  public static final String[] DEFAULT_KIND_ORDER = {MIGRATION_KIND__CHECK_MISSING_VP, MIGRATION_KIND__PATTERN, MIGRATION_KIND__SEMANTIC,
      MIGRATION_KIND__DIAGRAM, MIGRATION_KIND__AFM, MIGRATION_KIND__VIEWPOINT, MIGRATION_KIND__SCF};
}

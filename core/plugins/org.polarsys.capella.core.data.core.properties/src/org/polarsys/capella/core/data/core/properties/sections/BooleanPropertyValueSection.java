...
/**
 * The BooleanPropertyValue section.
 */
public class BooleanPropertyValueSection extends NamedElementSection {
  ...
  public void loadData(EObject capellaElement) {
    ...
    _valueGroup.loadData(capellaElement, CapellacorePackage.eINSTANCE.getBooleanPropertyValue_Value());
  }
  ...
  public boolean select(Object toTest) {
    ...
    return ((eObjectToTest != null) && (eObjectToTest.eClass() == CapellacorePackage.eINSTANCE.getBooleanPropertyValue()));
  }

...
/**
 * The StringPropertyValue section.
 */
public class StringPropertyValueSection extends NamedElementSection {
  ...
  public void loadData(EObject capellaElement) {
    ...
    _valueGroup.loadData(capellaElement, CapellacorePackage.eINSTANCE.getStringPropertyValue_Value());
  }
  ...
  public boolean select(Object toTest) {
    ...
    return ((eObjectToTest != null) && (eObjectToTest.eClass() == CapellacorePackage.eINSTANCE.getStringPropertyValue()));
  }

...
/**
 * The IntegerPropertyValue section.
 */
public class IntegerPropertyValueSection extends NamedElementSection {
  ...
  public void loadData(EObject capellaElement) {
    ...
    _valueGroup.loadData(capellaElement, CapellacorePackage.eINSTANCE.getIntegerPropertyValue_Value());
  }
  ...
  public boolean select(Object toTest) {
    ...
    return ((eObjectToTest != null) && (eObjectToTest.eClass() == CapellacorePackage.eINSTANCE.getIntegerPropertyValue()));
  }

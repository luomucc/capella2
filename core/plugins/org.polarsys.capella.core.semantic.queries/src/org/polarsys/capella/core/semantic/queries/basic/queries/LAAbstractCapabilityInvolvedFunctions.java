 ...
 *
 */
public class LAAbstractCapabilityInvolvedFunctions  extends AbstractCapabilityInvolvedFunctions {

	/**
	 * 
	 */
	public LAAbstractCapabilityInvolvedFunctions() {
    // do nothing
	}
  ...
  @Override
	public List<Object> compute(Object object) {
		...
		if (object instanceof CapabilityRealization) {
			...
			if (null != arch && arch instanceof LogicalArchitecture) {

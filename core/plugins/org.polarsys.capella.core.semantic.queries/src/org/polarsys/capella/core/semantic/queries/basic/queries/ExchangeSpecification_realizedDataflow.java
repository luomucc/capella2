...
/**
 * Return realized component Exchanges of current component exchange
 * 
 *
 */
public class ExchangeSpecification_realizedDataflow implements IQuery {

	/**
	 * 
	 */
	public ExchangeSpecification_realizedDataflow() {
	  // do nothing
	}

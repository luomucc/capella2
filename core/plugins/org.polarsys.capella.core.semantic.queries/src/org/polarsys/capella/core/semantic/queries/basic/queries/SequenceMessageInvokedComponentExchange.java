...
/**
 * Return invoked ComponentExchange(!Communication Mean) of given sequence message 
 */
public class SequenceMessageInvokedComponentExchange implements IQuery {
    ...
    if (object instanceof SequenceMessage) {
      ...
      if (null != sendingEnd) {
        ...
        if (event instanceof EventSentOperation) {
          ...
          if (operation instanceof ComponentExchange && !(operation instanceof CommunicationMean)) {

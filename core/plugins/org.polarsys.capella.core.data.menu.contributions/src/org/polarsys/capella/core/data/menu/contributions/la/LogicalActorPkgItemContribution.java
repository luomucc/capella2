...
public class LogicalActorPkgItemContribution implements IMDEMenuItemContribution {
  ...
  public boolean selectionContribution(ModelElement modelElement, EClass cls, EStructuralFeature feature) {
    return EcoreUtil2.isOrIsContainedBy(modelElement, LaPackage.Literals.LOGICAL_ARCHITECTURE);
  }
}

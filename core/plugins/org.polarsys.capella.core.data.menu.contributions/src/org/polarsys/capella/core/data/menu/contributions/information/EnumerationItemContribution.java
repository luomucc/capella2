...
public class EnumerationItemContribution implements IMDEMenuItemContribution {
	...
	public Command executionContribution(EditingDomain editingDomain, ModelElement containerElement, ModelElement createdElement, EStructuralFeature feature) {
		return new SetCommand(editingDomain, createdElement, DatatypePackage.Literals.DATA_TYPE__DISCRETE, Boolean.TRUE);
	}

...
public class LiteralNumericValue_Unit extends NumericValue_Unit implements IBusinessQuery {
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__LITERAL_NUMERIC_VALUE__UNIT, element, context);
  }
}

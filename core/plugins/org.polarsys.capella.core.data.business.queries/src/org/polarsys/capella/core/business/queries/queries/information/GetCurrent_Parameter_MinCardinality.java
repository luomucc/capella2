...
public class GetCurrent_Parameter_MinCardinality extends AbstractQuery {
	 ...
	 * </p>
	 * <p>
	 * Refer MQRY_Parameter_MinCard_1
	 * </p>
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		...
		if (element instanceof Parameter) {
			...
			if (parameter.getOwnedMinCard() != null) {
				currentElements.add(parameter.getOwnedMinCard());
			}
		}
		return currentElements;
	}

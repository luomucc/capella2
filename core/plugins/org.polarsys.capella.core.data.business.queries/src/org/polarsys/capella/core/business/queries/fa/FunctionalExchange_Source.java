...
public class FunctionalExchange_Source extends AbstractFunctionalExchangeItems implements IBusinessQuery {
  ...
  public List<EReference> getEStructuralFeatures() {
    return Arrays.asList(ActivityPackage.Literals.ACTIVITY_EDGE__SOURCE);
  }
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    ...
    return Collections.<EObject> singletonList(fe.getSource());
  }

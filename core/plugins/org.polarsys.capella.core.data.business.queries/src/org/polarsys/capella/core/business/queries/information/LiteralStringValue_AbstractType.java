...
public class LiteralStringValue_AbstractType extends AbstractValue_Type implements IBusinessQuery {
  ...
  public List<EObject> getAvailableElements(EObject element) {
    QueryContext context = new QueryContext();
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__LITERAL_STRING_VALUE__ABSTRACT_TYPE___LIB, element, context);
  }
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__LITERAL_STRING_VALUE__ABSTRACT_TYPE, element, context);
  }
}

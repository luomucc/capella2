...
public class ExchangeCategory_Exchanges implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__EXCHANGE_CATEGORY__EXCHANGES, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__EXCHANGE_CATEGORY__EXCHANGES, element, context);
	}
}

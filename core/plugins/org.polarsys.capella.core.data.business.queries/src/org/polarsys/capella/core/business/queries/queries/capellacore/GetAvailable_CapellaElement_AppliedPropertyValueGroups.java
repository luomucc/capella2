...
public class GetAvailable_CapellaElement_AppliedPropertyValueGroups extends AbstractQuery {
	...
	public List<CapellaElement> getAvailableElements(CapellaElement element) {
		...
		if (null != systemEngineering) {
			for (EObject elt : EObjectExt.getAll(systemEngineering, CapellacorePackage.Literals.PROPERTY_VALUE_GROUP)) {

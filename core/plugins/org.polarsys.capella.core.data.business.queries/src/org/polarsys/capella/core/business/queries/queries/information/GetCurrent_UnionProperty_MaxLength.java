...
public class GetCurrent_UnionProperty_MaxLength extends AbstractQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element,
		...
		if (element instanceof UnionProperty) {
			UnionProperty property = (UnionProperty) element;
			if (property.getOwnedMaxLength() != null) {
				currentElements.add(property.getOwnedMaxLength());
			}
		}
		return currentElements;
	}

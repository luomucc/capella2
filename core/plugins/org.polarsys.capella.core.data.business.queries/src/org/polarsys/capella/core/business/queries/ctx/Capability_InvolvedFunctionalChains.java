...
public class Capability_InvolvedFunctionalChains extends AbstractCapability_InvolvedFunctionalChains implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__CAPABILITY__INVOLVED_FUNCTIONAL_CHAINS, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__CAPABILITY__INVOLVED_FUNCTIONAL_CHAINS, element, context);
	}
}

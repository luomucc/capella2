...
public class GetCurrent_StringType_DefaultValue extends AbstractQuery {
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
    ...
    if (element instanceof StringType) {
      ...
      if (currentStringType.getOwnedDefaultValue() != null) {
        currentElements.add(currentStringType.getOwnedDefaultValue());
      }
    }
    return currentElements;
  }

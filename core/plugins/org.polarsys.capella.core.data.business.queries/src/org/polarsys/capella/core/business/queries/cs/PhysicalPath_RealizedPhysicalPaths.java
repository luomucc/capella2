...
public class PhysicalPath_RealizedPhysicalPaths implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__PHYSICAL_PATH__REALIZED_PHYSICAL_PATHS, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__PHYSICAL_PATH__REALIZED_PHYSICAL_PATHS, element, context);
	}
}

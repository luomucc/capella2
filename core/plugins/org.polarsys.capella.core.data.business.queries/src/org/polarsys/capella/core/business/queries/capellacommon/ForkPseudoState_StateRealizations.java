...
/**
 */
public class ForkPseudoState_StateRealizations extends AbstractState_AbstractStateRealizations implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__FORK_PSEUDO_STATE__STATE_REALIZATIONS, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__FORK_PSEUDO_STATE__STATE_REALIZATIONS, element, context);
	}
}

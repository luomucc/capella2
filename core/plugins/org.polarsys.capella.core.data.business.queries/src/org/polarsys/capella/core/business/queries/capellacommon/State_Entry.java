...
public class State_Entry extends AbstractState_Properties implements IBusinessQuery {
  ...
  public List<EReference> getEStructuralFeatures() {
    return Collections.singletonList(CapellacommonPackage.Literals.STATE__ENTRY);
  }

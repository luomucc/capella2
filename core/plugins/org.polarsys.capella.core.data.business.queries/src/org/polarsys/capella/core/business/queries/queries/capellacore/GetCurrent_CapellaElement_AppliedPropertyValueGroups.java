...
public class GetCurrent_CapellaElement_AppliedPropertyValueGroups extends AbstractQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		...
		for (PropertyValueGroup elt : element.getAppliedPropertyValueGroups()) {

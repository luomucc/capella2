...
public class FunctionInputPort_InComingExchangeItems extends AbstractFunctionalExchangeItems implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__FUNCTION_INPUT_PORT__IN_COMING_EXCHANGE_ITEMS___LIB, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__FUNCTION_INPUT_PORT__IN_COMING_EXCHANGE_ITEMS, element, context);
	}

...
/**
 */
public class OperationalActivity_AvailableInstates extends AbstractFunction_AvailableInStates implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__OPERATIONAL_ACTIVITY__AVAILABLE_INSTATES, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__OPERATIONAL_ACTIVITY__AVAILABLE_INSTATES, element, context);
	}
}

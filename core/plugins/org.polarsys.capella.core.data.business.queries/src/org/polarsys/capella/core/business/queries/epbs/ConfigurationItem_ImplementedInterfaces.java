...
public class ConfigurationItem_ImplementedInterfaces implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
	  QueryContext context = new QueryContext();
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__CONFIGURATION_ITEM__IMPLEMENTED_INTERFACES___LIB, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
	  QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__CONFIGURATION_ITEM__IMPLEMENTED_INTERFACES, element, context);
	}
}

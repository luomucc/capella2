...
/**
 * This is the query for the numeric references referenced value.
 */
public class NumericReference_ReferencedValue extends AbstractReference_ReferencedValue implements IBusinessQuery {
  ...
  @Override
    ...
    return Collections.singletonList(DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_VALUE);
  }

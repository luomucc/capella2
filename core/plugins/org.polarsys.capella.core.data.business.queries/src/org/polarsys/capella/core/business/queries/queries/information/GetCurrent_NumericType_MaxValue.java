...
public class GetCurrent_NumericType_MaxValue extends AbstractQuery {
  ...
  /**
   * <p>
   * Gets the current MaxValue of the NumericType
   * </p>
   * <p>
   * Refer MQRY_NumericType_MaxValue_1
   * </p>
   */
  public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
    ...
    if (element instanceof NumericType) {
      ...
      if (currentNumericType.getOwnedMaxValue() != null) {
        currentElements.add(currentNumericType.getOwnedMaxValue());
      }
    }
    return currentElements;
  }

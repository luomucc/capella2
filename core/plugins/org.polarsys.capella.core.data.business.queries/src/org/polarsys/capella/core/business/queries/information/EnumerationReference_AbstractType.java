...
/**
 * This is the query for enumeration references abstract type.
 */
public class EnumerationReference_AbstractType extends AbstractValue_Type implements IBusinessQuery {
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__ENUMERATION_REFERENCE__ABSTRACT_TYPE, element, context);
  }
}

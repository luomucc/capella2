...
public class GetCurrent_PhysicalQuantity_RealizedPhysicalQuantity extends AbstractQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		...
		if (element instanceof DataType) {
			for (InformationRealization elt : ((DataType) element).getOwnedInformationRealizations()) {

...
/**
 * This is the query for numeric references types.
 */
public class NumericReference_AbstractType extends AbstractValue_Type implements IBusinessQuery {
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__NUMERIC_REFERENCE__ABSTRACT_TYPE, element, context);
  }
}

 ...
 */
public class Parameter_MinCardinality extends CapellaElement_AbstractCardinality implements IBusinessQuery {
  /**
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
    context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
    return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__PARAMETER__MIN_CARDINALITY, element, context);
  }
}

...
public class GetCurrent_StringType_NullValue extends AbstractQuery {
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
    ...
    if (element instanceof StringType) {
      ...
      if (currentStringType.getNullValue() != null) {
        currentElements.add(currentStringType.getNullValue());
      }
    }
    return currentElements;
  }

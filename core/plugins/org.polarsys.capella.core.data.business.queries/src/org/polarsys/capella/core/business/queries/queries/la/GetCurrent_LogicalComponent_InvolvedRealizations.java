...
public class GetCurrent_LogicalComponent_InvolvedRealizations extends AbstractQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		...
		if (element instanceof LogicalComponent) {
			currentElements.addAll(SystemComponentExt.getInvolvedCapabilityRealisations((LogicalComponent) element));
		}
		return currentElements;
	}

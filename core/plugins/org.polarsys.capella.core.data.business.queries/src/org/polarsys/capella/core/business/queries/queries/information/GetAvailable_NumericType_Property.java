...
public class GetAvailable_NumericType_Property extends AbstractQuery {
	...
	public List<CapellaElement> getDataFromLevel(DataPkg dataPkg, CapellaElement dataType) {
		if (dataType instanceof DataType) {
			return CapellaElementsHelperForBusinessQueries.getPropertiesTypedBy(dataPkg, (DataType) dataType, true);
		}
		return Collections.emptyList();
	}

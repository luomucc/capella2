...
public class GetCurrent_PhysicalQuantity_NullValue extends AbstractQuery {
	...
	/** 
	 * Gets the current null value of the PhysicalDimension
	 */
	public List<CapellaElement> getCurrentElements(CapellaElement element,
		...
		if (element instanceof PhysicalQuantity) {
			...
			if (currentPhysicalDimension.getNullValue() != null) {
				currentElements.add(currentPhysicalDimension.getNullValue());
			}
		}
		return currentElements;
	}

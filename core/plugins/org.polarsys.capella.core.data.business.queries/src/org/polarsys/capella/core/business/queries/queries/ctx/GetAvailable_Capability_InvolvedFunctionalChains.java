...
public class GetAvailable_Capability_InvolvedFunctionalChains extends AbstractQuery {
	 ...
	 */
	private List<CapellaElement> getRule_MQRY_AbstractCapability_AvailableFunctionalChains_11(AbstractCapability ele) {
		List<CapellaElement> availableElements = new ArrayList<CapellaElement>();

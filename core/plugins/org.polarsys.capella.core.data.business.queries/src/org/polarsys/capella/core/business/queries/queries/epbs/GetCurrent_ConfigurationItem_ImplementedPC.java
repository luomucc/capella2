...
public class GetCurrent_ConfigurationItem_ImplementedPC extends AbstractQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		...
		if (element instanceof ConfigurationItem) {
			currentElements.addAll(((ConfigurationItem) element).getAllocatedPhysicalArtifacts());
		}

...
public class GetCurrent_NumericType_DefaultValue extends AbstractQuery {
  ...
  /**
   * <p>
   * Gets the default value of the current NumericType
   * </p>
   * <p>
   * Refer MQRY_NumericType_DefaultValue_1
   * </p>
   */
  public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
    ...
    if (element instanceof NumericType) {
      NumericType currentNumericType = (NumericType) element;
      if (currentNumericType.getOwnedDefaultValue() != null) {
        currentElements.add(currentNumericType.getOwnedDefaultValue());
      }
    }
    return currentElements;
  }

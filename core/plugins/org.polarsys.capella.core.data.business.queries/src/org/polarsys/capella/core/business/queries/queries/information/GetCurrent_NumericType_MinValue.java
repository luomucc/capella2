...
public class GetCurrent_NumericType_MinValue extends AbstractQuery {
  ...
  /**
   * <p>
   * Gets the current MinValue of the NumericType
   * </p>
   */
  public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
    ...
    if (element instanceof NumericType) {
      NumericType currentBooleanType = (NumericType) element;
      if (currentBooleanType.getOwnedMinValue() != null) {
        currentElements.add(currentBooleanType.getOwnedMinValue());
      }
    }
    return currentElements;
  }

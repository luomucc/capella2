...
/**
 * This is the query for collectionvalue types.
 */
public class CollectionValue_Type extends CapellaElement_CurrentAndHigherLevelsQuery implements IBusinessQuery {
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__COLLECTION_VALUE__TYPE, element, context);
  }
}

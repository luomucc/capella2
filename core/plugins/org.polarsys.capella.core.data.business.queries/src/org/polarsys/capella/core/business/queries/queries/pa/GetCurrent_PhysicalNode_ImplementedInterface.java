...
public class GetCurrent_PhysicalNode_ImplementedInterface extends AbstractQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		...
		if (element instanceof PhysicalComponent) {
			currentElements.addAll(ComponentExt.getImplementedInterfaces((PhysicalComponent) element));
		}
		return currentElements;
	}

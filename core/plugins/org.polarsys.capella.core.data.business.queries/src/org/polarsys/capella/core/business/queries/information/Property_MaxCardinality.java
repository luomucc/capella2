 ...
 */
public class Property_MaxCardinality extends CapellaElement_AbstractCardinality implements IBusinessQuery {
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__PROPERTY__MAX_CARDINALITY, element, context);
  }
}
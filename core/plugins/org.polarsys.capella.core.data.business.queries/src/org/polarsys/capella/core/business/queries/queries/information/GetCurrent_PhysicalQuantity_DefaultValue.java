...
public class GetCurrent_PhysicalQuantity_DefaultValue extends AbstractQuery {
  ...
  /**
   * Gets the current default value of the PhysicalDimension
   */
  public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
    ...
    if (element instanceof PhysicalQuantity) {
      ...
      if (currentPhysicalDimension.getOwnedDefaultValue() != null) {
        currentElements.add(currentPhysicalDimension.getOwnedDefaultValue());
      }
    }
    return currentElements;
  }

...
public class GetCurrent_PhysicalActor_LogicalActorRealization extends AbstractQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		...
		for (LogicalActorRealization aRealisation : ((PhysicalActor) element).getOwnedLogicalActorRealizations()) {

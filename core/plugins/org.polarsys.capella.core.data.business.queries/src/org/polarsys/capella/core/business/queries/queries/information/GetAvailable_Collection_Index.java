...
public class GetAvailable_Collection_Index extends AbstractQuery {
	...
	public List<EObject> getDataFromLevel(DataPkg dataPkg, CapellaElement capellaElement) {
		return CapellaElementsHelperForBusinessQueries.getOnlyDiscreteDatatypes(super_getDataFromLevel(dataPkg, capellaElement));
	}
  public List<EObject> super_getDataFromLevel(DataPkg dataPkg, CapellaElement capellaElement) {
    return CapellaElementsHelperForBusinessQueries.getCapellaElementsInstancesOf(dataPkg, getAvailableEClassForType(), null);
  }

...
public class CommunicationMean_FunctionalExchanges implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__COMMUNICATION_MEAN__FUNCTIONAL_EXCHANGES, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__COMMUNICATION_MEAN__FUNCTIONAL_EXCHANGES, element, context);
	}
}

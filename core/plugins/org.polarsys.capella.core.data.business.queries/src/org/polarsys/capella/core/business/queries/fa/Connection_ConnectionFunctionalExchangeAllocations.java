...
public class Connection_ConnectionFunctionalExchangeAllocations implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__CONNECTION__CONNECTION_FUNCTIONAL_EXCHANGE_ALLOCATIONS, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__CONNECTION__CONNECTION_FUNCTIONAL_EXCHANGE_ALLOCATIONS, element, context);
	}
}

...
public class GetCurrent_CollectionValueRefReferencedProperty extends AbstractQuery {
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
    ...
    if (element instanceof CollectionValueReference) {
      CollectionValueReference reference = (CollectionValueReference) element;

...
public class GetCurrent_Collection_MaxCardinality extends AbstractQuery {
	 ...
	 * @see org.polarsys.capella.core.business.queries.capellacore.common.ui.business.queries.IBusinessQuery#getCurrentElements(EObject,boolean)
	 */
	public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
		...
		if (element instanceof Collection) {
			...
			if (collection.getOwnedMaxCard() != null) {
				currentElements.add(collection.getOwnedMaxCard());
			}
		}
		return currentElements;
	}

 ...
 */
public class Parameter_MaxValue extends AbstractMultiplicityElement_NullValue implements IBusinessQuery {
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
    context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
    return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__PARAMETER__MAX_VALUE, element, context);
  }
}

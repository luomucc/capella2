...
public class GetAvailable_FinalState_AvailableInStates extends AbstractQuery {
	 ...
	 * @param state
	 */
	private List<CapellaElement> getRule_MQRY_State_AvailableFunctions_11(State state) {
	 ...
	 * @return
	 */
	private List<CapellaElement> getElementsFromBlockArchitecture(BlockArchitecture arch, State state) {
		List<CapellaElement> availableElements = new ArrayList<CapellaElement>(1);
		if (arch != null) {

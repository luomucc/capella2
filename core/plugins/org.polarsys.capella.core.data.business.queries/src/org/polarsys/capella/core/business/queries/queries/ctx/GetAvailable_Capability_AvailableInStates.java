...
public class GetAvailable_Capability_AvailableInStates extends AbstractQuery {
	 ...
	 */
	private void getElementsFromOperationalAnalysisLayer(CapellaElement ele, BlockArchitecture blockArch, List<CapellaElement> availableElements) {
	 ...
	 * @param availableElements
	 */
	private void getElementsFromSystemAnalysisLayer(CapellaElement ele, BlockArchitecture blockArch, List<CapellaElement> availableElements) {
	 ...
	 * @param availableElements
	 */
	private void getElementsFromLogicalLayer(CapellaElement ele, BlockArchitecture blockArch, List<CapellaElement> availableElements) {
	 ...
	 * @param availableElements
	 */
	private void getElementsFromPhysicalLayer(CapellaElement ele, BlockArchitecture blockArch, List<CapellaElement> availableElements) {
	 ...
	 * @param availableElements
	 */
	private void getElementsFromEPBSLayer(CapellaElement ele, BlockArchitecture blockArchitecture, List<CapellaElement> availableElements) {
	 ...
	 * @return
	 */
	private List<CapellaElement> getElementsFromBlockArchitecture(Component comp, CapellaElement ele) {
		List<CapellaElement> availableElements = new ArrayList<CapellaElement>(1);
		if (comp != null) {

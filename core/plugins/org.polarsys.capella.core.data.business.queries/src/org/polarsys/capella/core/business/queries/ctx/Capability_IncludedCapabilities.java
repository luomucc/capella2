...
public class Capability_IncludedCapabilities implements IBusinessQuery {
  ...
  public List<EReference> getEStructuralFeatures() {
	...
	public List<EObject> getAvailableElements(EObject element) {
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__CAPABILITY__INCLUDED_CAPABILITIES, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
		QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__CAPABILITY__INCLUDED_CAPABILITIES, element, context);
	}

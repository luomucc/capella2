...
public class System_UsedInterfaces implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element) {
	  QueryContext context = new QueryContext();
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__SYSTEM__USED_INTERFACES___LIB, element, context);
	}
	...
	public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
	  QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__SYSTEM__USED_INTERFACES, element, context);
	}
}

...
public class Part_DeployedElements implements IBusinessQuery {
  ...
  public List<EObject> getAvailableElements(EObject element) {
    QueryContext context = new QueryContext();
		...
		return QueryInterpretor.executeQuery(QueryConstants.GET_AVAILABLE__PART__DEPLOYED_ELEMENTS___LIB, element, context);
  }
  ...
  public List<EObject> getCurrentElements(EObject element, boolean onlyGenerated) {
    QueryContext context = new QueryContext();
		context.putValue(QueryConstants.ECLASS_PARAMETER, getEClass());
		return QueryInterpretor.executeQuery(QueryConstants.GET_CURRENT__PART__DEPLOYED_ELEMENTS, element, context);
  }

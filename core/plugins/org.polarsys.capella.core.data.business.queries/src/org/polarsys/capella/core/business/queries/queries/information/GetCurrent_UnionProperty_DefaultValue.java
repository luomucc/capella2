...
public class GetCurrent_UnionProperty_DefaultValue extends AbstractQuery {
  ...
  public List<CapellaElement> getCurrentElements(CapellaElement element, boolean onlyGenerated) {
    ...
    if (element instanceof MultiplicityElement) {
      ...
      if (mElement.getOwnedDefaultValue() != null) {
        currentElements.add(mElement.getOwnedDefaultValue());
      }
    }
    return currentElements;
  }

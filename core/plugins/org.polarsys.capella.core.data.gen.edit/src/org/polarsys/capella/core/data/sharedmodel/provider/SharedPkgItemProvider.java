...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.sharedmodel.SharedPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SharedPkgItemProvider
	 ...
	 * @generated
	 */
	public SharedPkgItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addReuseLinksPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReuseableStructure_reuseLinks_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ReuseableStructure_reuseLinks_feature", "_UI_ReuseableStructure_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CapellacorePackage.Literals.REUSEABLE_STRUCTURE__REUSE_LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SharedmodelPackage.Literals.SHARED_PKG__OWNED_DATA_PKG);
			childrenFeatures.add(SharedmodelPackage.Literals.SHARED_PKG__OWNED_GENERIC_PKG);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SharedPkg")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((SharedPkg)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_SharedPkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SharedPkg.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (SharedmodelPackage.Literals.SHARED_PKG__OWNED_DATA_PKG,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (SharedmodelPackage.Literals.SHARED_PKG__OWNED_GENERIC_PKG,

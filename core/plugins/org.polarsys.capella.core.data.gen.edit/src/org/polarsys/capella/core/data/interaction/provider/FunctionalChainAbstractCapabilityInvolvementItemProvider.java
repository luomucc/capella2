...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.interaction.FunctionalChainAbstractCapabilityInvolvement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionalChainAbstractCapabilityInvolvementItemProvider
	 ...
	 * @generated
	 */
	protected IItemPropertyDescriptor functionalChainPropertyDescriptor;
	 ...
	 * @generated
	 */
	public FunctionalChainAbstractCapabilityInvolvementItemProvider(AdapterFactory adapterFactory) {
	...
	public void checkChildCreationExtender(Object object) {
		...
		if (object instanceof EObject) {
			...
			// Process InteractionPackage.Literals.FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENT__CAPABILITY
			if (capabilityPropertyDescriptor != null) {
				Object capabilityValue = eObject.eGet(InteractionPackage.Literals.FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENT__CAPABILITY, true);
				...
				} else if (capabilityValue == null && ExtensionModelManager.getAnyType(eObject, InteractionPackage.Literals.FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENT__CAPABILITY) != null) {
					itemPropertyDescriptors.remove(capabilityPropertyDescriptor);				  					
			...
			// Process InteractionPackage.Literals.FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENT__FUNCTIONAL_CHAIN
			if (functionalChainPropertyDescriptor != null) {
				Object functionalChainValue = eObject.eGet(InteractionPackage.Literals.FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENT__FUNCTIONAL_CHAIN, true);
				if (functionalChainValue != null && functionalChainValue instanceof EObject && ModelExtensionHelper.getInstance(eObject).isExtensionModelDisabled((EObject) functionalChainValue)) {
					itemPropertyDescriptors.remove(functionalChainPropertyDescriptor);
				} else if (functionalChainValue == null && ExtensionModelManager.getAnyType(eObject, InteractionPackage.Literals.FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENT__FUNCTIONAL_CHAIN) != null) {
					itemPropertyDescriptors.remove(functionalChainPropertyDescriptor);				  					
				} else if (itemPropertyDescriptors.contains(functionalChainPropertyDescriptor) == false) {
					itemPropertyDescriptors.add(functionalChainPropertyDescriptor);
				}
			}
		}		
	}
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFunctionalChainPropertyDescriptor(object);
		}
	...
	protected void addCapabilityPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionalChainAbstractCapabilityInvolvement_capability_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionalChainAbstractCapabilityInvolvement_capability_feature", "_UI_FunctionalChainAbstractCapabilityInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InteractionPackage.Literals.FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENT__CAPABILITY,
				 false,
				 false,
				 false,
				 null,
	...
	/**
	 * This adds a property descriptor for the Functional Chain feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFunctionalChainPropertyDescriptor(Object object) {
		// begin-extension-code
		functionalChainPropertyDescriptor = createItemPropertyDescriptor
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionalChainAbstractCapabilityInvolvement_functionalChain_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionalChainAbstractCapabilityInvolvement_functionalChain_feature", "_UI_FunctionalChainAbstractCapabilityInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InteractionPackage.Literals.FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENT__FUNCTIONAL_CHAIN,
				 false,
				 false,
				 false,
				 null,
	...
	/**
	 * This returns FunctionalChainAbstractCapabilityInvolvement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FunctionalChainAbstractCapabilityInvolvement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_FunctionalChainAbstractCapabilityInvolvement_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_FunctionalChainAbstractCapabilityInvolvement_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.information.datavalue.NumericReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumericReferenceItemProvider extends NumericValueItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
  ...
  /**
	 ...
	 * @generated
	 */
	public NumericReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	public void checkChildCreationExtender(Object object) {
		...
		if (object instanceof EObject) {
			...
			// Process DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_VALUE
			if (referencedValuePropertyDescriptor != null) {
				Object referencedValueValue = eObject.eGet(DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_VALUE, true);
				...
				} else if (referencedValueValue == null && ExtensionModelManager.getAnyType(eObject, DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_VALUE) != null) {
					itemPropertyDescriptors.remove(referencedValuePropertyDescriptor);				  					
			...
			// Process DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_PROPERTY
			if (referencedPropertyPropertyDescriptor != null) {
				Object referencedPropertyValue = eObject.eGet(DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_PROPERTY, true);
				...
				} else if (referencedPropertyValue == null && ExtensionModelManager.getAnyType(eObject, DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_PROPERTY) != null) {
					itemPropertyDescriptors.remove(referencedPropertyPropertyDescriptor);				  					
	...
	protected void addReferencedValuePropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NumericReference_referencedValue_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_NumericReference_referencedValue_feature", "_UI_NumericReference_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addReferencedPropertyPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NumericReference_referencedProperty_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_NumericReference_referencedProperty_feature", "_UI_NumericReference_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 DatavaluePackage.Literals.NUMERIC_REFERENCE__REFERENCED_PROPERTY,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns NumericReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NumericReference")); //$NON-NLS-1$
	}
  ...
  public String getTextGen(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((NumericReference)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_NumericReference_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
  ...
  public String getText(Object object) {
    ...
    if (null != valueSuffix && "" != valueSuffix) { //$NON-NLS-1$
      label += " " + valueSuffix; //$NON-NLS-1$
    }

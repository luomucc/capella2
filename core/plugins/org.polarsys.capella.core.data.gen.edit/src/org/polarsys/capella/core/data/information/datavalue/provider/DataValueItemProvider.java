...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.information.datavalue.DataValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataValueItemProvider
	...
	public void checkChildCreationExtender(Object object) {
		...
		if (object instanceof EObject) {
			...
			// Process DatavaluePackage.Literals.DATA_VALUE__TYPE
			if (typePropertyDescriptor != null) {
				Object typeValue = eObject.eGet(DatavaluePackage.Literals.DATA_VALUE__TYPE, true);
				...
				} else if (typeValue == null && ExtensionModelManager.getAnyType(eObject, DatavaluePackage.Literals.DATA_VALUE__TYPE) != null) {
					itemPropertyDescriptors.remove(typePropertyDescriptor);				  					
	...
	protected void addAbstractPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataValue_abstract_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_DataValue_abstract_feature", "_UI_DataValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 DatavaluePackage.Literals.DATA_VALUE__ABSTRACT,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataValue_type_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_DataValue_type_feature", "_UI_DataValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 DatavaluePackage.Literals.DATA_VALUE__TYPE,
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_DataValue_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

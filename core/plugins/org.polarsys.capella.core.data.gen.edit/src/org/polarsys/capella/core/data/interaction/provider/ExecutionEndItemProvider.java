...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.interaction.ExecutionEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecutionEndItemProvider
	extends AbstractEndItemProvider
	implements
	 ...
	 * @generated
	 */
	protected IItemPropertyDescriptor executionPropertyDescriptor;
		...
		if (object instanceof EObject) {
			...
			if (executionPropertyDescriptor != null) {
				...
				if (executionValue != null && executionValue instanceof EObject && ModelExtensionHelper.getInstance(eObject).isExtensionModelDisabled((EObject) executionValue)) {
					...
					itemPropertyDescriptors.remove(executionPropertyDescriptor);				  					
				} else if (itemPropertyDescriptors.contains(executionPropertyDescriptor) == false) {
					itemPropertyDescriptors.add(executionPropertyDescriptor);
				}
			}
		}		
	}
	...
	protected void addExecutionPropertyDescriptor(Object object) {
		// begin-extension-code
		executionPropertyDescriptor = createItemPropertyDescriptor
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InteractionPackage.Literals.EXECUTION_END__EXECUTION,
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_ExecutionEnd_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

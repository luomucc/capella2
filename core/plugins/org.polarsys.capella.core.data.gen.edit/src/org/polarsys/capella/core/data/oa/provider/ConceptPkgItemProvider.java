...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.oa.ConceptPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConceptPkgItemProvider
	 ...
	 * @generated
	 */
	public ConceptPkgItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OaPackage.Literals.CONCEPT_PKG__OWNED_CONCEPT_PKGS);
			childrenFeatures.add(OaPackage.Literals.CONCEPT_PKG__OWNED_CONCEPTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConceptPkg")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((ConceptPkg)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_ConceptPkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConceptPkg.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (OaPackage.Literals.CONCEPT_PKG__OWNED_CONCEPT_PKGS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (OaPackage.Literals.CONCEPT_PKG__OWNED_CONCEPTS,

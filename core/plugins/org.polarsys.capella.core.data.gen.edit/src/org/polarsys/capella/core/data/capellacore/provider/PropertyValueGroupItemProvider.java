...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.capellacore.PropertyValueGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyValueGroupItemProvider
	 ...
	 * @generated
	 */
	public PropertyValueGroupItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addValuedElementsPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyValueGroup_valuedElements_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyValueGroup_valuedElements_feature", "_UI_PropertyValueGroup_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CapellacorePackage.Literals.PROPERTY_VALUE_GROUP__VALUED_ELEMENTS,
				 false,
				 false,
				 false,
				 null,
	...
	/**
	 * This returns PropertyValueGroup.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PropertyValueGroup")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((PropertyValueGroup)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_PropertyValueGroup_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PropertyValueGroup.class)) {

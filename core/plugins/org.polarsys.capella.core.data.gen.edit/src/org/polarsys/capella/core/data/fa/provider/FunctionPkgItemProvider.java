...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.fa.FunctionPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionPkgItemProvider
	 ...
	 * @generated
	 */
	public FunctionPkgItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FaPackage.Literals.FUNCTION_PKG__OWNED_FUNCTIONAL_LINKS);
			childrenFeatures.add(FaPackage.Literals.FUNCTION_PKG__OWNED_EXCHANGES);
			childrenFeatures.add(FaPackage.Literals.FUNCTION_PKG__OWNED_EXCHANGE_SPECIFICATION_REALIZATIONS);
			childrenFeatures.add(FaPackage.Literals.FUNCTION_PKG__OWNED_CATEGORIES);
			childrenFeatures.add(FaPackage.Literals.FUNCTION_PKG__OWNED_FUNCTION_SPECIFICATIONS);
		}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((FunctionPkg)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_FunctionPkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctionPkg.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (FaPackage.Literals.FUNCTION_PKG__OWNED_FUNCTIONAL_LINKS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (FaPackage.Literals.FUNCTION_PKG__OWNED_EXCHANGES,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (FaPackage.Literals.FUNCTION_PKG__OWNED_CATEGORIES,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (FaPackage.Literals.FUNCTION_PKG__OWNED_FUNCTION_SPECIFICATIONS,

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.capellamodeller.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CapellamodellerPackage.Literals.PROJECT__KEY_VALUE_PAIRS);
			childrenFeatures.add(CapellamodellerPackage.Literals.PROJECT__OWNED_FOLDERS);
			childrenFeatures.add(CapellamodellerPackage.Literals.PROJECT__OWNED_MODEL_ROOTS);
		}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_Project_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CapellamodellerPackage.Literals.PROJECT__KEY_VALUE_PAIRS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CapellamodellerPackage.Literals.PROJECT__OWNED_FOLDERS,

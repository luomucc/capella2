...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.ctx.MissionPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MissionPkgItemProvider
	 ...
	 * @generated
	 */
	public MissionPkgItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CtxPackage.Literals.MISSION_PKG__OWNED_MISSION_PKGS);
			childrenFeatures.add(CtxPackage.Literals.MISSION_PKG__OWNED_MISSIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MissionPkg")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((MissionPkg)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_MissionPkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MissionPkg.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CtxPackage.Literals.MISSION_PKG__OWNED_MISSION_PKGS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CtxPackage.Literals.MISSION_PKG__OWNED_MISSIONS,

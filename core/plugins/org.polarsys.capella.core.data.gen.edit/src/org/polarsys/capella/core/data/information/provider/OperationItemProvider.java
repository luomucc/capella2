...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.information.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAllocatingOperationsPropertyDescriptor(object);
			addAllocatedOperationsPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Allocating Operations feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAllocatingOperationsPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_allocatingOperations_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_allocatingOperations_feature", "_UI_Operation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InformationPackage.Literals.OPERATION__ALLOCATING_OPERATIONS,
				 false,
				 false,
				 false,
				 null,
	...
	/**
	 * This adds a property descriptor for the Allocated Operations feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAllocatedOperationsPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_allocatedOperations_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_allocatedOperations_feature", "_UI_Operation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InformationPackage.Literals.OPERATION__ALLOCATED_OPERATIONS,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addRealizedExchangeItemsPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_realizedExchangeItems_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_realizedExchangeItems_feature", "_UI_Operation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InformationPackage.Literals.OPERATION__REALIZED_EXCHANGE_ITEMS,
				 false,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InformationPackage.Literals.OPERATION__OWNED_PARAMETERS);
			childrenFeatures.add(InformationPackage.Literals.OPERATION__OWNED_OPERATION_ALLOCATION);
			childrenFeatures.add(InformationPackage.Literals.OPERATION__OWNED_EXCHANGE_ITEM_REALIZATIONS);
		}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_Operation_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
		...
		super.collectNewChildDescriptors(newChildDescriptors, object);
                // begin-extension-code
                {
                    CommandParameter commandParameter = createChildParameter
                        (InformationPackage.Literals.OPERATION__OWNED_PARAMETERS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (InformationPackage.Literals.OPERATION__OWNED_OPERATION_ALLOCATION,

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.information.datavalue.AbstractEnumerationValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractEnumerationValueItemProvider
	 ...
	 * @generated
	 */
	public AbstractEnumerationValueItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((AbstractEnumerationValue)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_AbstractEnumerationValue_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

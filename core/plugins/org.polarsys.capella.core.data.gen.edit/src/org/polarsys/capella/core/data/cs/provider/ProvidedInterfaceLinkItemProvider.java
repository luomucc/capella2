...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.cs.ProvidedInterfaceLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProvidedInterfaceLinkItemProvider
	 ...
	 * @generated
	 */
	public ProvidedInterfaceLinkItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addInterfacePropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProvidedInterfaceLink_interface_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ProvidedInterfaceLink_interface_feature", "_UI_ProvidedInterfaceLink_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CsPackage.Literals.PROVIDED_INTERFACE_LINK__INTERFACE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_ProvidedInterfaceLink_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_ProvidedInterfaceLink_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

	...
	public static class ModellingcoreChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends ModellingcoreSwitch<Object> {
			...
			public Object caseAbstractConstraint(AbstractConstraint object) {
				...
				if (ModelExtensionHelper.getInstance(object).isExtensionModelDisabled(EcoreUtil.getRootContainer(object).eClass().getEPackage().getNsURI(), "http://www.polarsys.org/capella/core/information/datavalue/1.2.0")) { //$NON-NLS-1$
					return null;				
				}
				// end-extension-code
                // begin-extension-code

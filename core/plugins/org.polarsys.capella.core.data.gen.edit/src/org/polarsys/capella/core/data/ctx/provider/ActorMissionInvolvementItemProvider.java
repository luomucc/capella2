...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.ctx.ActorMissionInvolvement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorMissionInvolvementItemProvider
	 ...
	 * @generated
	 */
	public ActorMissionInvolvementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addActorPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActorMissionInvolvement_actor_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ActorMissionInvolvement_actor_feature", "_UI_ActorMissionInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CtxPackage.Literals.ACTOR_MISSION_INVOLVEMENT__ACTOR,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addMissionPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActorMissionInvolvement_mission_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ActorMissionInvolvement_mission_feature", "_UI_ActorMissionInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CtxPackage.Literals.ACTOR_MISSION_INVOLVEMENT__MISSION,
				 false,
				 false,
				 false,
				 null,
	...
	/**
	 * This returns ActorMissionInvolvement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ActorMissionInvolvement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_ActorMissionInvolvement_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_ActorMissionInvolvement_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

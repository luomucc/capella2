...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.capellamodeller.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FolderItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CapellamodellerPackage.Literals.FOLDER__OWNED_FOLDERS);
			childrenFeatures.add(CapellamodellerPackage.Literals.FOLDER__OWNED_MODEL_ROOTS);
		}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_Folder_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CapellamodellerPackage.Literals.FOLDER__OWNED_FOLDERS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CapellamodellerPackage.Literals.FOLDER__OWNED_MODEL_ROOTS,

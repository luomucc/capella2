...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.interaction.SequenceMessageValuation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceMessageValuationItemProvider
	 ...
	 * @generated
	 */
	protected IItemPropertyDescriptor exchangeItemElementPropertyDescriptor;
	 ...
	 * @generated
	 */
	public SequenceMessageValuationItemProvider(AdapterFactory adapterFactory) {
		...
		if (object instanceof EObject) {
			...
			if (exchangeItemElementPropertyDescriptor != null) {
				...
				if (exchangeItemElementValue != null && exchangeItemElementValue instanceof EObject && ModelExtensionHelper.getInstance(eObject).isExtensionModelDisabled((EObject) exchangeItemElementValue)) {
					...
					itemPropertyDescriptors.remove(exchangeItemElementPropertyDescriptor);				  					
				} else if (itemPropertyDescriptors.contains(exchangeItemElementPropertyDescriptor) == false) {
					itemPropertyDescriptors.add(exchangeItemElementPropertyDescriptor);
				}
			}
	...
	/**
	 * This adds a property descriptor for the Exchange Item Element feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addExchangeItemElementPropertyDescriptor(Object object) {
		// begin-extension-code
		exchangeItemElementPropertyDescriptor = createItemPropertyDescriptor
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SequenceMessageValuation_exchangeItemElement_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_SequenceMessageValuation_exchangeItemElement_feature", "_UI_SequenceMessageValuation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InteractionPackage.Literals.SEQUENCE_MESSAGE_VALUATION__EXCHANGE_ITEM_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValuePropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SequenceMessageValuation_value_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_SequenceMessageValuation_value_feature", "_UI_SequenceMessageValuation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InteractionPackage.Literals.SEQUENCE_MESSAGE_VALUATION__VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SequenceMessageValuation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SequenceMessageValuation")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_SequenceMessageValuation_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_SequenceMessageValuation_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SequenceMessageValuation.class)) {

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.information.datatype.NumericType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumericTypeItemProvider
	...
	protected void addKindPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NumericType_kind_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_NumericType_kind_feature", "_UI_NumericType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 DatatypePackage.Literals.NUMERIC_TYPE__KIND,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatatypePackage.Literals.NUMERIC_TYPE__OWNED_DEFAULT_VALUE);
			childrenFeatures.add(DatatypePackage.Literals.NUMERIC_TYPE__OWNED_NULL_VALUE);
			childrenFeatures.add(DatatypePackage.Literals.NUMERIC_TYPE__OWNED_MIN_VALUE);
			childrenFeatures.add(DatatypePackage.Literals.NUMERIC_TYPE__OWNED_MAX_VALUE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NumericType")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_NumericType_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
		...
		super.collectNewChildDescriptors(newChildDescriptors, object);
                // begin-extension-code
                {
                    CommandParameter commandParameter = createChildParameter
                        (DatatypePackage.Literals.NUMERIC_TYPE__OWNED_DEFAULT_VALUE,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (DatatypePackage.Literals.NUMERIC_TYPE__OWNED_MIN_VALUE,
                         DatavalueFactory.eINSTANCE.createLiteralNumericValue());
                    if (NewChildDescriptorHelper.isValidCommand(object, commandParameter)) {
                        newChildDescriptors.add(commandParameter);      
                    }
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (DatatypePackage.Literals.NUMERIC_TYPE__OWNED_MAX_VALUE,
                         DatavalueFactory.eINSTANCE.createLiteralNumericValue());
                    if (NewChildDescriptorHelper.isValidCommand(object, commandParameter)) {
                        newChildDescriptors.add(commandParameter);      
                    }

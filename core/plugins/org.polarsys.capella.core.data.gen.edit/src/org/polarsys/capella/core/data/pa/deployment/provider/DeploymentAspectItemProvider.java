...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.pa.deployment.DeploymentAspect} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentAspectItemProvider
	 ...
	 * @generated
	 */
	public DeploymentAspectItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeploymentPackage.Literals.DEPLOYMENT_ASPECT__OWNED_CONFIGURATIONS);
			childrenFeatures.add(DeploymentPackage.Literals.DEPLOYMENT_ASPECT__OWNED_DEPLOYMENT_ASPECTS);
		}
	...
	/**
	 * This returns DeploymentAspect.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeploymentAspect")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((DeploymentAspect)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_DeploymentAspect_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeploymentAspect.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (DeploymentPackage.Literals.DEPLOYMENT_ASPECT__OWNED_CONFIGURATIONS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (DeploymentPackage.Literals.DEPLOYMENT_ASPECT__OWNED_DEPLOYMENT_ASPECTS,

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.pa.deployment.DeploymentConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentConfigurationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeploymentPackage.Literals.DEPLOYMENT_CONFIGURATION__OWNED_DEPLOYMENT_LINKS);
			childrenFeatures.add(DeploymentPackage.Literals.DEPLOYMENT_CONFIGURATION__OWNED_PHYSICAL_INSTANCES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeploymentConfiguration")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((DeploymentConfiguration)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_DeploymentConfiguration_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
		...
		super.collectNewChildDescriptors(newChildDescriptors, object);
                // begin-extension-code
                {
                    CommandParameter commandParameter = createChildParameter
                        (DeploymentPackage.Literals.DEPLOYMENT_CONFIGURATION__OWNED_DEPLOYMENT_LINKS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (DeploymentPackage.Literals.DEPLOYMENT_CONFIGURATION__OWNED_PHYSICAL_INSTANCES,

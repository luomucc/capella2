...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.fa.ComponentPortAllocationEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentPortAllocationEndItemProvider
	 ...
	 * @generated
	 */
	public ComponentPortAllocationEndItemProvider(AdapterFactory adapterFactory) {
	...
	public void checkChildCreationExtender(Object object) {
		...
		if (object instanceof EObject) {
			...
			// Process FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END__PORT
			if (portPropertyDescriptor != null) {
				Object portValue = eObject.eGet(FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END__PORT, true);
				...
				} else if (portValue == null && ExtensionModelManager.getAnyType(eObject, FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END__PORT) != null) {
					itemPropertyDescriptors.remove(portPropertyDescriptor);				  					
				} else if (itemPropertyDescriptors.contains(portPropertyDescriptor) == false) {
					itemPropertyDescriptors.add(portPropertyDescriptor);
				}
			}
			// Process FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END__PART
			if (partPropertyDescriptor != null) {
				Object partValue = eObject.eGet(FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END__PART, true);
				...
				} else if (partValue == null && ExtensionModelManager.getAnyType(eObject, FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END__PART) != null) {
					itemPropertyDescriptors.remove(partPropertyDescriptor);				  					
	...
	protected void addPortPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentPortAllocationEnd_port_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentPortAllocationEnd_port_feature", "_UI_ComponentPortAllocationEnd_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END__PORT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPartPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentPortAllocationEnd_part_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentPortAllocationEnd_part_feature", "_UI_ComponentPortAllocationEnd_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END__PART,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ComponentPortAllocationEnd.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComponentPortAllocationEnd")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_ComponentPortAllocationEnd_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_ComponentPortAllocationEnd_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComponentPortAllocationEnd.class)) {

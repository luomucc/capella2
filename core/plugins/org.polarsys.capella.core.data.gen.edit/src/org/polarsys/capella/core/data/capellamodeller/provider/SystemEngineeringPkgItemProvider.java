...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.capellamodeller.SystemEngineeringPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemEngineeringPkgItemProvider
	 ...
	 * @generated
	 */
	public SystemEngineeringPkgItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CapellamodellerPackage.Literals.SYSTEM_ENGINEERING_PKG__OWNED_SYSTEM_ENGINEERINGS);
		}
	...
	/**
	 * This returns SystemEngineeringPkg.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SystemEngineeringPkg")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((SystemEngineeringPkg)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_SystemEngineeringPkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SystemEngineeringPkg.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CapellamodellerPackage.Literals.SYSTEM_ENGINEERING_PKG__OWNED_SYSTEM_ENGINEERINGS,

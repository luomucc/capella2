...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.information.datatype.BooleanType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatatypePackage.Literals.BOOLEAN_TYPE__OWNED_LITERALS);
			childrenFeatures.add(DatatypePackage.Literals.BOOLEAN_TYPE__OWNED_DEFAULT_VALUE);
		}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_BooleanType_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DatatypePackage.Literals.BOOLEAN_TYPE__OWNED_LITERALS ||
			childFeature == DatatypePackage.Literals.BOOLEAN_TYPE__OWNED_DEFAULT_VALUE;

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.ctx.SystemMissionInvolvement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemMissionInvolvementItemProvider
	 ...
	 * @generated
	 */
	protected IItemPropertyDescriptor missionPropertyDescriptor;
	 ...
	 * @generated
	 */
	public SystemMissionInvolvementItemProvider(AdapterFactory adapterFactory) {
	...
	public void checkChildCreationExtender(Object object) {
		...
		if (object instanceof EObject) {
			...
			// Process CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__MISSION
			if (missionPropertyDescriptor != null) {
				Object missionValue = eObject.eGet(CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__MISSION, true);
				...
				} else if (missionValue == null && ExtensionModelManager.getAnyType(eObject, CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__MISSION) != null) {
					itemPropertyDescriptors.remove(missionPropertyDescriptor);				  					
				} else if (itemPropertyDescriptors.contains(missionPropertyDescriptor) == false) {
					itemPropertyDescriptors.add(missionPropertyDescriptor);
				}
			}
			// Process CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__SYSTEM
			if (systemPropertyDescriptor != null) {
				Object systemValue = eObject.eGet(CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__SYSTEM, true);
				...
				} else if (systemValue == null && ExtensionModelManager.getAnyType(eObject, CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__SYSTEM) != null) {
					itemPropertyDescriptors.remove(systemPropertyDescriptor);				  					
	...
	protected void addMissionPropertyDescriptor(Object object) {
		// begin-extension-code
		missionPropertyDescriptor = createItemPropertyDescriptor
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SystemMissionInvolvement_mission_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_SystemMissionInvolvement_mission_feature", "_UI_SystemMissionInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__MISSION,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addSystemPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SystemMissionInvolvement_system_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_SystemMissionInvolvement_system_feature", "_UI_SystemMissionInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CtxPackage.Literals.SYSTEM_MISSION_INVOLVEMENT__SYSTEM,
				 false,
				 false,
				 false,
				 null,
	...
	/**
	 * This returns SystemMissionInvolvement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SystemMissionInvolvement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_SystemMissionInvolvement_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_SystemMissionInvolvement_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

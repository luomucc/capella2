...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.ctx.ActorCapabilityInvolvement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorCapabilityInvolvementItemProvider
	 ...
	 * @generated
	 */
	public ActorCapabilityInvolvementItemProvider(AdapterFactory adapterFactory) {
	...
	public void checkChildCreationExtender(Object object) {
		...
		if (object instanceof EObject) {
			...
			// Process CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__ACTOR
			if (actorPropertyDescriptor != null) {
				Object actorValue = eObject.eGet(CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__ACTOR, true);
				...
				} else if (actorValue == null && ExtensionModelManager.getAnyType(eObject, CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__ACTOR) != null) {
					itemPropertyDescriptors.remove(actorPropertyDescriptor);				  					
			...
			// Process CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__CAPABILITY
			if (capabilityPropertyDescriptor != null) {
				Object capabilityValue = eObject.eGet(CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__CAPABILITY, true);
				...
				} else if (capabilityValue == null && ExtensionModelManager.getAnyType(eObject, CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__CAPABILITY) != null) {
					itemPropertyDescriptors.remove(capabilityPropertyDescriptor);				  					
	...
	protected void addActorPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActorCapabilityInvolvement_actor_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ActorCapabilityInvolvement_actor_feature", "_UI_ActorCapabilityInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__ACTOR,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addCapabilityPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActorCapabilityInvolvement_capability_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ActorCapabilityInvolvement_capability_feature", "_UI_ActorCapabilityInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CtxPackage.Literals.ACTOR_CAPABILITY_INVOLVEMENT__CAPABILITY,
				 false,
				 false,
				 false,
				 null,
	...
	/**
	 * This returns ActorCapabilityInvolvement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ActorCapabilityInvolvement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_ActorCapabilityInvolvement_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_ActorCapabilityInvolvement_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

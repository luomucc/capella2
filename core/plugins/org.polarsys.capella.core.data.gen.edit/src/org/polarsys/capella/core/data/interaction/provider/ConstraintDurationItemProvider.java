...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.interaction.ConstraintDuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintDurationItemProvider
	 ...
	 * @generated
	 */
	public ConstraintDurationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDurationPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstraintDuration_duration_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstraintDuration_duration_feature", "_UI_ConstraintDuration_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InteractionPackage.Literals.CONSTRAINT_DURATION__DURATION,
				 true,
				 false,
				 false,
	...
	protected void addStartPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstraintDuration_start_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstraintDuration_start_feature", "_UI_ConstraintDuration_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InteractionPackage.Literals.CONSTRAINT_DURATION__START,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFinishPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstraintDuration_finish_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstraintDuration_finish_feature", "_UI_ConstraintDuration_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 InteractionPackage.Literals.CONSTRAINT_DURATION__FINISH,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ConstraintDuration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConstraintDuration")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((ConstraintDuration)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_ConstraintDuration_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConstraintDuration.class)) {

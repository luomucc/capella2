...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.oa.RolePkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RolePkgItemProvider
	 ...
	 * @generated
	 */
	public RolePkgItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OaPackage.Literals.ROLE_PKG__OWNED_ROLE_PKGS);
			childrenFeatures.add(OaPackage.Literals.ROLE_PKG__OWNED_ROLES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RolePkg")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((RolePkg)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_RolePkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RolePkg.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (OaPackage.Literals.ROLE_PKG__OWNED_ROLE_PKGS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (OaPackage.Literals.ROLE_PKG__OWNED_ROLES,

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.capellacore.KeyValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KeyValueItemProvider extends ModelElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
  ...
  /**
	...
	protected void addKeyPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_KeyValue_key_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_KeyValue_key_feature", "_UI_KeyValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CapellacorePackage.Literals.KEY_VALUE__KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValuePropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_KeyValue_value_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_KeyValue_value_feature", "_UI_KeyValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 CapellacorePackage.Literals.KEY_VALUE__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/KeyValue")); //$NON-NLS-1$
	}
  ...
  public String getTextGen(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_KeyValue_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_KeyValue_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
  ...
  public String getText(Object object) {
    String label = ""; //$NON-NLS-1$
    String keyName = ((KeyValue) object).getKey();
    String valueName = ((KeyValue) object).getValue();

    if (null != keyName && "" != keyName) { //$NON-NLS-1$
      label = "[" + keyName + "]"; //$NON-NLS-1$ //$NON-NLS-2$
      if (null != valueName || "" != valueName) { //$NON-NLS-1$
        label += " " + valueName; //$NON-NLS-1$
      }
    }
    else {
      label = "[" + getString("_UI_KeyValue_type") + "]"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }

	...
	public static class ActivityChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends ActivitySwitch<Object> {
			...
			public Object caseAbstractActivity(AbstractActivity object) {
				...
				if (ModelExtensionHelper.getInstance(object).isExtensionModelDisabled(EcoreUtil.getRootContainer(object).eClass().getEPackage().getNsURI(), "http://www.polarsys.org/capella/core/la/1.2.0")) { //$NON-NLS-1$
					return null;				
				}
				// end-extension-code
                // begin-extension-code

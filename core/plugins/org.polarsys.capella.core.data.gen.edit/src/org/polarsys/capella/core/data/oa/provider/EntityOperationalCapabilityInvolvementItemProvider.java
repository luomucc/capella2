...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.oa.EntityOperationalCapabilityInvolvement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityOperationalCapabilityInvolvementItemProvider
	 ...
	 * @generated
	 */
	public EntityOperationalCapabilityInvolvementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addEntityPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntityOperationalCapabilityInvolvement_entity_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_EntityOperationalCapabilityInvolvement_entity_feature", "_UI_EntityOperationalCapabilityInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 OaPackage.Literals.ENTITY_OPERATIONAL_CAPABILITY_INVOLVEMENT__ENTITY,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addCapabilityPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntityOperationalCapabilityInvolvement_capability_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_EntityOperationalCapabilityInvolvement_capability_feature", "_UI_EntityOperationalCapabilityInvolvement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 OaPackage.Literals.ENTITY_OPERATIONAL_CAPABILITY_INVOLVEMENT__CAPABILITY,
				 false,
				 false,
				 false,
				 null,
	...
	/**
	 * This returns EntityOperationalCapabilityInvolvement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EntityOperationalCapabilityInvolvement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
        ...
        EObject target = null;
	 	...
	 	label = "[" + getString("_UI_EntityOperationalCapabilityInvolvement_type") + "] to " + targetName; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_EntityOperationalCapabilityInvolvement_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code

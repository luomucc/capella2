...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.ctx.ActorPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorPkgItemProvider
	 ...
	 * @generated
	 */
	public ActorPkgItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CtxPackage.Literals.ACTOR_PKG__OWNED_ACTORS);
			childrenFeatures.add(CtxPackage.Literals.ACTOR_PKG__OWNED_ACTOR_PKGS);
			childrenFeatures.add(CtxPackage.Literals.ACTOR_PKG__OWNED_SYSTEM_COMMUNICATION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ActorPkg")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
    	...
    	//begin-capella-code
		String label = ((ActorPkg)object).getName();
		//end-capella-code
	  
	
			result[0] = label == null || label.length() == 0 ?
			//begin-capella-code
			"[" + getString("_UI_ActorPkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ActorPkg.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewChildDescriptors(newChildDescriptors, object);
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CtxPackage.Literals.ACTOR_PKG__OWNED_ACTORS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CtxPackage.Literals.ACTOR_PKG__OWNED_ACTOR_PKGS,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (CtxPackage.Literals.ACTOR_PKG__OWNED_SYSTEM_COMMUNICATION,

...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.core.data.information.datatype.StringType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatatypePackage.Literals.STRING_TYPE__OWNED_DEFAULT_VALUE);
			childrenFeatures.add(DatatypePackage.Literals.STRING_TYPE__OWNED_NULL_VALUE);
			childrenFeatures.add(DatatypePackage.Literals.STRING_TYPE__OWNED_MIN_LENGTH);
			childrenFeatures.add(DatatypePackage.Literals.STRING_TYPE__OWNED_MAX_LENGTH);
		}
	...
	public String getText(Object object) {
	 String[] result = new String[] { null };
		...
		//end-capella-code
			...
			//begin-capella-code
			"[" + getString("_UI_StringType_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			//end-capella-code
		...
		super.collectNewChildDescriptors(newChildDescriptors, object);
                // begin-extension-code
                {
                    CommandParameter commandParameter = createChildParameter
                        (DatatypePackage.Literals.STRING_TYPE__OWNED_DEFAULT_VALUE,
                ...
                {
                    CommandParameter commandParameter = createChildParameter
                        (DatatypePackage.Literals.STRING_TYPE__OWNED_MIN_LENGTH,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DatatypePackage.Literals.STRING_TYPE__OWNED_DEFAULT_VALUE ||
			childFeature == DatatypePackage.Literals.STRING_TYPE__OWNED_NULL_VALUE ||
			childFeature == DatatypePackage.Literals.STRING_TYPE__OWNED_MIN_LENGTH ||
			childFeature == DatatypePackage.Literals.STRING_TYPE__OWNED_MAX_LENGTH;

...
/**
 */
public class ScenarioRefinementAction extends AbstractTigAction {
  private static final String PROGRESS_BAR_NAME = "Scenario refinement processing..."; //$NON-NLS-1$
  ...
  public void run(IAction action) {
    IRunnableWithProgress runnable = new IRunnableWithProgress() {
      ...
      public void run(IProgressMonitor progressMonitor) throws InvocationTargetException, InterruptedException {
        ...
        getExecutionManager().execute(new ScenarioRefinementCommand(getSelectedElement(), progressMonitor));
      }
    };
    try {
